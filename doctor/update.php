...
if (isset($_REQUEST['edit'])) {
    ...
    $pass=mysqli_query($con,"SELECT * FROM doctordata WHERE doctor_passid=".$passid);
...
if (isset($_POST['submit'])) {
    ...
    $doctor_passid = $_POST['doctor_passid'];
    $doctor_service = $_POST['doctor_service'];

    
    // mysqli_query("UPDATE blogEntry SET content = $udcontent, title = $udtitle WHERE id = $id");
    $res=mysqli_query($con,"UPDATE doctordata SET doctor_Fname='$doctor_Fname', doctor_Lname='$doctor_Lname', doctor_phone='$doctor_phone',  doctor_passid='$doctor_passid',  doctor_service='$doctor_service' WHERE doctor_passid='$passid'");
                              ...
                              <div class="row">
                               <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <option value="ทันตกรรมทั่วไป" <?php echo ($docRow['doctor_service'] == 'ทันตกรรมทั่วไป') ? 'selected' : ''; ?>>ทันตกรรมทั่วไป</option>
                                    <option value="นทันตกรรมความงาม" <?php echo ($docRow['doctor_service'] == 'ทันตกรรมความงาม') ? 'selected' : ''; ?>>ทันตกรรมความงาม</option>
                                ...
                                <div class="form-group form-group-lg">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="doctor_Fname" class="form-control" value="<?= $docRow['doctor_Fname'];?>" required>
                                    </div>
                                </div>
                                <div class="form-group form-group-lg">
                                    <label class="control-label col-sm-2 requiredField" for="service">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text"name="doctor_Lname" class="form-control"  value="<?= $docRow['doctor_Lname'];?>"required>
                                    </div>
                                </div>
                                <div class="form-group form-group-lg">
                                    <label class="control-label col-sm-2 requiredField" for="service">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="doctor_phone" class="form-control"  value="<?= $docRow['doctor_phone'];?>"required>
                                    </div>
                                </div>
                                </div>
                                <div class="form-group form-group-lg">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="doctor_passid" class="form-control"  value="<?= $docRow['doctor_passid'];?>" required  >
                                    </div>
                                </div>
