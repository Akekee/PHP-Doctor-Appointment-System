						...
						<div class="col-md-3 col-sm-3">
							...
							<div class="user-wrapper">
								...
								<div class="description">
									...
									<h5> <strong> คลินิกทันตกรรมทับปุด (Thap Put Dental Clinc.) </strong></h5>
									<p>
										เราพร้อมดูแลรอยยิ้มของคุณ ด้วยหัวใจ โปรดเพิ่มข้อมูลส่วนตัวของคุณเพิ่มเติม 
									</p>
									<hr />
									<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">เพิ่มข้อมูลส่วนตัว</button>
								</div>
							</div>
						</div>
								...
								<div class="panel panel-default">
									<div class="panel-body">
										...
										<form class="form" role="form" method="POST" accept-charset="UTF-8">
											<div class="panel panel-default">
												<div class="panel-heading">ข้อมูลของผู้ป่วย</div>
												<div class="panel-body">
													
													ชื่อ-นามสกุลe: <?php echo $userRow['patientFirstName'] ?> <?php echo $userRow['patientLastName'] ?><br>
											...
											<div class="panel panel-default">
												...
												<div class="panel-body">
													...
													<h3><font color="red" size="4">***กรุณามาตามวันเเละเวลาที่จอง***</font></h3>

												</div>
											</div>
											<div class="form-group">
												<label for="service-type" class="control-label">ต้องการรับบริการ</label>
